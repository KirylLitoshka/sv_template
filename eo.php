...
<p class="notification" style="
 ...
 <form enctype="multipart/form-data" method="post" id="form" action="eo_start_new.php" >
...
<!-- <input class="V2" type="radio"  name="v1" value="v1">Электронное обращение граждан</a> -->
 ...
 <p>Ваша фамилия, собственное имя, отчество:</p>                           <input required placeholder="" name="user_name" type="text" >
 <p>Ваш адрес места жительства (места пребывания):</p>                     <input required placeholder="" name="user_url" type="text" >
 <p>Ваш контактный телефон:</p>                                            <input required placeholder="" name="user_tel" type="text" >
 <p>Ваш E-mail:</p>                                                        <input required placeholder="" name="user_email" type="email" >
